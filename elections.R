...
#less smart way to do it

r78 <- sum(elections$year == 1978 & elections$cand_sex == 'F') / 
  sum(elections$year == 1978  & elections$cand_sex == 'M')

r79 <- sum(elections$year == 1979 & elections$cand_sex == 'F') / 
  sum(elections$year == 1979  & elections$cand_sex == 'M')

r80 <- sum(elections$year == 1980 & elections$cand_sex == 'F') / 
  sum(elections$year == 1980  & elections$cand_sex == 'M')

r81 <- sum(elections$year == 1981 & elections$cand_sex == 'F') / 
  sum(elections$year == 1981  & elections$cand_sex == 'M', na.rm = TRUE)

r82 <- sum(elections$year == 1982 & elections$cand_sex == 'F') / 
  sum(elections$year == 1982  & elections$cand_sex == 'M')

r83 <- sum(elections$year == 1983 & elections$cand_sex == 'F') / 
  sum(elections$year == 1983  & elections$cand_sex == 'M')

r84 <- sum(elections$year == 1984& elections$cand_sex == 'F') / 
  sum(elections$year == 1984  & elections$cand_sex == 'M')

r85 <- sum(elections$year == 1985 & elections$cand_sex == 'F') / 
  sum(elections$year == 1985  & elections$cand_sex == 'M')

r86 <- sum(elections$year == 1986 & elections$cand_sex == 'F') / 
  sum(elections$year == 1986  & elections$cand_sex == 'M', na.rm = TRUE)

r87 <- sum(elections$year == 1987 & elections$cand_sex == 'F') / 
  sum(elections$year == 1987  & elections$cand_sex == 'M')

r88 <- sum(elections$year == 1988 & elections$cand_sex == 'F') / 
  sum(elections$year == 1988  & elections$cand_sex == 'M')

r89 <- sum(elections$year == 1989 & elections$cand_sex == 'F') / 
  sum(elections$year == 1989  & elections$cand_sex == 'M')

r90 <- sum(elections$year == 1990 & elections$cand_sex == 'F') / 
  sum(elections$year == 1990  & elections$cand_sex == 'M')

r91 <- sum(elections$year == 1991 & elections$cand_sex == 'F') / 
  sum(elections$year == 1991  & elections$cand_sex == 'M')

r92 <- sum(elections$year == 1992 & elections$cand_sex == 'F') / 
  sum(elections$year == 1992  & elections$cand_sex == 'M')

r93 <- sum(elections$year == 1993 & elections$cand_sex == 'F') / 
  sum(elections$year == 1993  & elections$cand_sex == 'M')

r94 <- sum(elections$year == 1994 & elections$cand_sex == 'F') / 
  sum(elections$year == 1994  & elections$cand_sex == 'M')

r95 <- sum(elections$year == 1995 & elections$cand_sex == 'F') / 
  sum(elections$year == 1995  & elections$cand_sex == 'M')

r96 <- sum(elections$year == 1996 & elections$cand_sex == 'F') / 
  sum(elections$year == 1996  & elections$cand_sex == 'M')

r97 <- sum(elections$year == 1997 & elections$cand_sex == 'F') / 
  sum(elections$year == 1997  & elections$cand_sex == 'M')

r98 <- sum(elections$year == 1998 & elections$cand_sex == 'F') / 
  sum(elections$year == 1998  & elections$cand_sex == 'M')

r99 <- sum(elections$year == 1999 & elections$cand_sex == 'F') / 
  sum(elections$year == 1999  & elections$cand_sex == 'M')

r00 <- sum(elections$year == 2000 & elections$cand_sex == 'F') / 
  sum(elections$year == 2000  & elections$cand_sex == 'M')

r01 <- sum(elections$year == 2001 & elections$cand_sex == 'F') / 
  sum(elections$year == 2001  & elections$cand_sex == 'M')

r02 <- sum(elections$year == 2002 & elections$cand_sex == 'F') / 
  sum(elections$year == 2002  & elections$cand_sex == 'M')

r03 <- sum(elections$year == 2003 & elections$cand_sex == 'F') / 
  sum(elections$year == 2003  & elections$cand_sex == 'M')

r04 <- sum(elections$year == 2004 & elections$cand_sex == 'F') / 
  sum(elections$year == 2004  & elections$cand_sex == 'M')

r05 <- sum(elections$year == 2005 & elections$cand_sex == 'F') / 
  sum(elections$year == 2005  & elections$cand_sex == 'M')

r06 <- sum(elections$year == 2006 & elections$cand_sex == 'F') / 
  sum(elections$year == 2006  & elections$cand_sex == 'M')

r07 <- sum(elections$year == 2007 & elections$cand_sex == 'F') / 
  sum(elections$year == 2007  & elections$cand_sex == 'M')

r08 <- sum(elections$year == 2008 & elections$cand_sex == 'F') / 
  sum(elections$year == 2008  & elections$cand_sex == 'M')

r09 <- sum(elections$year == 2009 & elections$cand_sex == 'F') / 
  sum(elections$year == 2009  & elections$cand_sex == 'M')

r10 <- sum(elections$year == 2010 & elections$cand_sex == 'F') / 
  sum(elections$year == 2010  & elections$cand_sex == 'M')

r11 <- sum(elections$year == 2011 & elections$cand_sex == 'F') / 
  sum(elections$year == 2011  & elections$cand_sex == 'M')

r12 <- sum(elections$year == 2012 & elections$cand_sex == 'F') / 
  sum(elections$year == 2012  & elections$cand_sex == 'M')

r13 <- sum(elections$year == 2013 & elections$cand_sex == 'F') / 
  sum(elections$year == 2013  & elections$cand_sex == 'M')

r14 <- sum(elections$year == 2014 & elections$cand_sex == 'F') / 
  sum(elections$year == 2014  & elections$cand_sex == 'M')

r15 <- sum(elections$year == 2015 & elections$cand_sex == 'F') / 
  sum(elections$year == 2015  & elections$cand_sex == 'M')


gen_ratios <- c(r78, r79, r80, r81, r82, r83, r84, r85, r86, r87, r88, r89, r90, r91, r92, r93, r94, r95, r96, r97, r98, r99, r00, r01, r02, r03, r04, r05, r06, r07, r08, r09, r10, r11, r12, r13, r14, r15)

year_ratio <- c(1978, 1979, 1980, 1981, 1982, 1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015)
